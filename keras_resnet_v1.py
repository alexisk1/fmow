...
def generator(samples, batch_size=32,image_datagen):
...
#train_generator = generator(train_samples, batch_size=32,image_datagen)
#validation_generator = generator(validation_samples, batch_size=32,image_datagen)
...
model.compile(loss='categorical_crossentropy',
              optimizer='adam',
              metrics=['accuracy'])
model.fit_generator(train_generator, samples_per_epoch=len(train_samples), validation_data=validation_generator, nb_val_samples=len(validation_samples), nb_epoch=6)
